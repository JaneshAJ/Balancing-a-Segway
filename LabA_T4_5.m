...
[afLinearizedBotZeros, afLinearizedBotPoles, fLinearizedBotGain] = ss2zp(A, B, C, D,2);
ComputePIDGains;
...
open_system('LabA_T4_5_Model.slx')
saveas(get_param('LabA_T4_5_Model','Handle'),'LabA_LinearizedBotSimulink_diagram.eps');
sim('LabA_T4_5_Model')
close_system('LabA_T4_5_Model')
